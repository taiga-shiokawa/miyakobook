			...
			{isEditing && (
				<div className='mt-4'>
					...
					<button
						...
						className='bg-[#5fced8] text-white py-2 px-4 rounded hover:bg-primary-dark transition duration-300'
					>
						学歴を追加
					</button>
				</div>
			...
			{isOwnProfile && (
				<>
					{isEditing ? (
						<button
							onClick={handleSave}
							className='mt-4 bg-[#5fced8] text-white py-2 px-4 rounded hover:bg-primary-dark
